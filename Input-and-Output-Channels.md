...
Issues: Compositionality, hierarchical composition should be better captured, as a zoom operator alone might not suffice, also pixel-by-pixel comparison is quite limited.

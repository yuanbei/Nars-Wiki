...
Note: It should take about 5-7 minutes to complete since it will be running some tests. It is possible to skip tests by issuing command: **_mvn install -DskipTests=True_ **
<br/><br/>
**6.**
<br/><br/>
**7.**

...
Logical foundation of OpenNARS reasoning operates on well known [syllogistic inference rules](https://github.com/opennars/opennars/wiki/Basic-Syllogistic-Rules). It introduces key features of OpenNARS: inheritance relation, use of evidence through truth value, inference rules, truth functions and simple Narsese [grammar]((https://github.com/opennars/opennars/wiki/Narsese-Grammar,-Language-of-OpenNARS)). <br/>
...
The next  similarity, instance and property relations and modifies truth functions. 

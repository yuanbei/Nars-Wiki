The symbols in Narsese have two versions: the version used in publications and the version used in the OpenNARS implementation. Their correspondence is given in the following table. 
